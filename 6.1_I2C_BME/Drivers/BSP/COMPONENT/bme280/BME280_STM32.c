...
//
//    // Transmit chip ID register address (0xD0)
//    status = HAL_I2C_Master_Transmit(&hi2c1, BME280_ADDRESS,  1, HAL_MAX_DELAY);
//    if(status != HAL_OK) {
...
//
//    // Receive chip ID
//    status = HAL_I2C_Master_Receive(&hi2c1, BME280_ADDRESS << 1 | 0x01, &chipID, 1, HAL_MAX_DELAY);
//    if(status != HAL_OK) {
